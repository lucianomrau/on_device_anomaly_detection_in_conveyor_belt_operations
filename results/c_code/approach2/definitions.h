...
#elif defined UINT32
  uint32_t v_features_quant[N_FEATURES]={0};
#elif defined UINT16
  uint16_t v_features_quant[N_FEATURES]={0};
#elif defined UINT8
...
//#elif defined UINT8
//  const uint8_t threshold_speed=quantization(2.5f/45.55f);
//#endif
const float threshold_speed=2.5f/45.55f;
...
//// Function to compute the median of a 1D array of 3 elements
//uint8_t computeMedian(unsigned int arr[],uint8_t pred) {
//  //circular buffer
...
//
//    // Sort the array
//    bubbleSort(arr, MEDIAN_FILTER_ORDER);
//
//    // Calculate the median
//    return (uint8_t) arr[MEDIAN_FILTER_ORDER / 2];
//    //return (uint8_t) arr[1];
//}
